...
public class FormularioEmpleado extends JDialog {
	...
	public FormularioEmpleado(Frame owner, EmpleadoController empleadoController, Empleado empleado,
		...
		// Establece el título del diálogo según si se está agregando o actualizando un
		// empleado
		...
		btnGuardar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (guardarEmpleado()) { // Llama al método para guardar el empleado
		...
		// Añade el panel de campos y el panel de botón al diálogo
	...
	private boolean guardarEmpleado() {
		...
		return resultado; // Retorna true si se guardó correctamente
	}
}
